...
public class WritePenaltyOld {
	...
	public static void main(String[] args) {
		...
		Background bg = new Background(bgElements);
		...
		try {
			...
			while ((str = in.readLine()) != null) {
				...
				int penaltyInt = (int) (penalty * 10);
				String penaltyString = "penalty(" + ruleNr + ", " + "1" + ") <- ";
				String result = penaltyString.concat(auxString2);
				
				penaltyList.add(ruleNr, penaltyInt);
